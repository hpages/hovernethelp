### Manually create the '~/collected_infer_results/TCGA-PRAD/' folder
...
PRAD_db <- subset(db, Project.ID %in% PROJECT_ID)
message("Total nb of images from ", PROJECT_ID, " project ",
        "in TCGA db: ", nrow(PRAD_db))

allowed_image_filenames <- PRAD_db[ , "File.Name"]
